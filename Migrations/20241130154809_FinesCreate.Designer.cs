...
namespace Digesett.Migrations
{
    ...
    [Migration("20241130154809_FinesCreate")]
    partial class FinesCreate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Digesett.Models.Agent", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 11, 30, 15, 48, 6, 571, DateTimeKind.Utc).AddTicks(2074),
                            IsActive = true,
                            Name = "Agente Demo",
                            Password = "$2a$11$27PdFGrdLcRs6jZe4.2srecactxnZghTRqUN4rW70fJI6eMYEZzqK"
                        });
                });
